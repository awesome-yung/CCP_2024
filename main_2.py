...
wandb.init(entity='2024CCP', project='yumin', name='bfloat16')
...
train_2(model, train_loader, valid_loader, criterion, optimizer, NUM_EPOCHS, VAL_EVERY, file_name)